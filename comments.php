<div id="yorumtemp">
<div class="yorumbaslik">YAPILAN YORUMLAR</div>
<div class="yorumlar">
...
<?php if(comments_open()) : ?>
    <?php if(get_option('comment_registration') && !$user_ID) : ?>
        ...
        <form action="<?php echo get_option('siteurl'); ?>/wp-comments-post.php" method="post" id="commentform">
            ...
            <?php else : ?>
                <p><input  type="text" name="author" id="author" value="<?php echo $comment_author; ?>" size="22" tabindex="1" placeholder="Adınız Soyadınız <?php if($req) echo "(Gerekli)"; ?>"/></p>
                <p><input type="text" name="email" id="email" value="<?php echo $comment_author_email; ?>" size="22" tabindex="2" placeholder="E-Mail <?php if($req) echo "(Gerekli)"; ?>"/></p>
                <p><input type="text" name="url" id="url" value="<?php echo $comment_author_url; ?>" size="22" tabindex="3"  placeholder="Web Site <?php if($req) echo "(Gerekli)"; ?>"/></p>
            <?php endif; ?>
            <p><textarea placeholder="Adınız Soyadınız" name="comment" id="comment" cols="100%" rows="10" tabindex="4"></textarea></p>
